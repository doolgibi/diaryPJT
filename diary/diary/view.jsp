				...
				<table width="210" height="145" border="0" cellspacing="0"
					...
					<tr>
						<td width="210" height="50" align="left" class="title"><img
							src="../jsp_img/point.gif" border="0" align="absmiddle">&nbsp;<%= year %>년
							<%= month %>월 <%= day %>일 <br>&nbsp;&nbsp;스캐줄은 없습니다.</td>
					</tr>
					<tr>
						<td width="210"></td>
					</tr>
					...
					<table>
						<table width="210" height="25" border="0" cellspacing="0"
							...
							<tr>
								<td width="210" height="20" align="center"><a
									href="calendar.jsp"><img src="../jsp_img/list.gif"
										border="0" alt="diary_list.gif" align="absmiddle"></a> <a
									href="diary_login.jsp?mode=<%= mode %>&year=<%= year %>&month=<%= month %>&day=<%= day %>"><img
										src="../jsp_img/write.gif" border="0" alt="new_write.gif"
...
%>
						<table width="210" height="145" border="0" cellspacing="0"
							...
							<tr>
								<td width="210" height="20" align="left" class="title">&nbsp;<%= year %>년
									<%= month %>월 <%= day %>일
								</td>
							</tr>
							<tr>
						...
						<table width="210" height="25" border="0" cellspacing="0"
							...
							<tr>
								<td width="210" height="20" align="center"><a
									href="calendar.jsp"><img src="../jsp_img/list.gif"
										border="0" alt="diary_list.gif" align="absmiddle"></a> <a
									href="diary_login.jsp?mode=modify&id=<%= id %>"><img
										src="../jsp_img/modify.gif" border="0" alt="modify.gif"
										align="absmiddle"></a> <a
									href="diary_login.jsp?mode=delete&id=<%= id %>"><img
										src="../jsp_img/delete.gif" border="0" alt="delete.gif"
										align="absmiddle"></a></td>
							</tr>
							<tr>
								<td width="210" height="1" bgcolor="#D2FCFC"></td>
